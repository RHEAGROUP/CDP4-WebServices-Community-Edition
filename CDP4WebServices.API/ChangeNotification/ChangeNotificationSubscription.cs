// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ChangeNotificationSubscription.cs" company="RHEA System S.A.">
...
namespace CDP4WebServices.API.ChangeNotification
{
    ...
    {
        /// <summary>
        /// Gets the <see cref="ChangeNotification.ChangeNotificationSubscriptionType"/> of the subscription.
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public ChangeNotificationSubscriptionType ChangeNotificationSubscriptionType { get; set; }
        ...
        /// The <see cref="CDP4Common.CommonData.ClassKind"/> of the subscribed <see cref="Thing"/>
        /// </param>
        /// <param name="changeNotificationSubscriptionType">
        /// The <see cref="ChangeNotification.ChangeNotificationSubscriptionType"/>
        /// </param>
        [JsonConstructor]
